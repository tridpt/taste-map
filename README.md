...
- Lưu ảnh quán trực tiếp trong trình duyệt; ảnh được lưu riêng trong IndexedDB (chỉ giữ id/album trong `localStorage` để tránh đầy) và phân loại theo album (món, không gian, menu, khác).
